...
#define BOARD_BOOTCLOCKRUN_LCDIF_CLK_ROOT             14210526UL     /* Clock consumers of LCDIF_CLK_ROOT output : LCDIF */
...
#define BOARD_BOOTCLOCKRUN_SEMC_CLK_ROOT              150000000UL    /* Clock consumers of SEMC_CLK_ROOT output : SEMC */
